...
Transaction::Transaction(int receipt_number, string isbn, string username); {
    this->receipt_number = trans_id;  // Set unique transaction ID
...
void Transaction::displayTransactionInfo() const {
    cout << "Transaction ID: " << receipt_number << endl;
